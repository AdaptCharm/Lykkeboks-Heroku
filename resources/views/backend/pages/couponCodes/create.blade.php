...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="content col-lg-12">
      ...
      <form action="{{ route('admin.couponCodes.store') }}" method="post" enctype="multipart/form-data">
        ...
        <a href="{{ route('admin.couponCodes.index') }}" class="btn btn-success btn-outline btn-sm">Tilbake</a>
